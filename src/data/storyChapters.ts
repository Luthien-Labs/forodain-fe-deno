...
export const STORY_CHAPTERS: Chapter[] = [
  ...
  {
    _id: 'stub2',
    title: 'The House at Greyditch',
    sections: [
      {
        image: '/img/hovel-library.webp',
        paragraphs: [
          'The Loremaster has not yet committed this chapter to paper. Check back once the notes have been recovered from the satchel.',
        ],
      },
    ],
  },
  {
    _id: 'stub3',
    title: 'Salt, Smoke, and the Widow',
    sections: [
      {
  ...
  {
    _id: 'stub4',
    title: "Beneath the Cartwright’s Floor",
    sections: [
      {
  ...
  {
    _id: 'stub5',
    title: 'The Hanging Court of Saern',
    sections: [
      {
        image: '/img/gallowstree.webp',
        paragraphs: [
          'The Loremaster has not yet committed this chapter to paper. Check back once the notes have been recovered from the satchel.',
        ],
      },
